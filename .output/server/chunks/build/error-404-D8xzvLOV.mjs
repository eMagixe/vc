import { v as vue_exports, u as useHead$1, s as server_renderer_exports, N as NuxtLink } from '../virtual/entry.mjs';
...
//#region node_modules/.pnpm/nuxt@4.5.1_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0_supports-color@10.2.2___@_2710ed8ff482fdf48e9bb1212f06470a/node_modules/nuxt/dist/app/components/error-404.vue
var _sfc_main = {
	__name: "error-404",
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${(0, server_renderer_exports.ssrRenderAttrs)((0, vue_exports.mergeProps)({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-34f9b9d0><div class="max-w-520px text-center" data-v-34f9b9d0><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-34f9b9d0>${(0, server_renderer_exports.ssrInterpolate)(__props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-34f9b9d0>${(0, server_renderer_exports.ssrInterpolate)(__props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-34f9b9d0>${(0, server_renderer_exports.ssrInterpolate)(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-34f9b9d0>`);
...
_sfc_main.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.5.1_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0_supports-color@10.2.2___@_2710ed8ff482fdf48e9bb1212f06470a/node_modules/nuxt/dist/app/components/error-404.vue");
