...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [{
	name: "account",
	path: "/account",
	component: () => import('../build/account-CjNX4Zit.mjs')
}, {
	name: "index",
	path: "/",
	component: () => import('../build/pages-juQnIaC6.mjs')
}];
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-DI-EQXLX.mjs'));
		const _Error = defineAsyncComponent(() => import('../build/error-500-DwOX5P1O.mjs'));
...
export { _plugin_vue_export_helper_default as _, useHead$1 as a, useRouter as b, useRuntimeConfig as c, nuxtLinkDefaults as d, encodeRoutePath as e, entry as f, navigateTo as n, resolveRouteObject as r, stateDiagnostics as s, useNuxtApp as u };
